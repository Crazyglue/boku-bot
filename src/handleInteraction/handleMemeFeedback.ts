...
import { BlockElementAction, DialogSubmitAction, InteractiveAction, WorkflowStepEdit } from '@slack/bolt';
...
type PossibleAction = DialogSubmitAction | WorkflowStepEdit | BlockElementAction | InteractiveAction;

// export default async function handleMemeFeedback(event: PossibleAction): Promise<SlackAPI.OriginalMessage> {
export default async function handleMemeFeedback(event: PossibleAction): Promise<any> {
